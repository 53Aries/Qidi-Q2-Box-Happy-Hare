...
KLIPPER_BIN="/home/mks/klipper_box_max4.bin"
KLIPPER_MCU="/dev/serial/by-id/usb-Klipper_QIDI_PLUS4-BOX-*"
# BOOTLOADER_MCU="/dev/serial/by-id/usb-*-CDC_*" # GD32
BOOTLOADER_MCU="/dev/serial/by-id/usb-*_Virtual_ComPort_*" # STM32

echo "Start mcu_update_QD_Plus_Box.sh, version: $VERSION"
# ./mcu_update_QD_Plus_Box.sh $KLIPPER_BIN $KLIPPER_MCU $BOOTLOADER_MCU $RESET_CMD
